...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_tea) { described_class.new('Earl Grey', 16) }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_tea.type).to eq('Earl Grey')
      end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      ...
      subject(:my_pepsi) { described_class.new('Pepsi') }

      # remove the 'x' before running this test
      it 'is full' do
        expect(my_pepsi).to be_full
      end
    end
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_pepsi) { described_class.new('Pepsi', 2) }

      # remove the 'x' before running this test
      it 'is not full' do
        expect(my_pepsi).to_not be_full
      end
    end
  end
end
